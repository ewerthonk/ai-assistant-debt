...
st.title("Teste 5. Maior interação entre o usuário e o chatbot")
st.caption(
    "**Caso de teste:** Usuário troca maior número de mensagens com o chatbot (inclusive após já estar autenticado). \n\n"
    "**Objetivo:** checar se o chatbot tem capacidade de apresentar uma conversa fluida com o usuário."
)
with st.sidebar:
